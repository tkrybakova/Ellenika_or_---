const F1_DRIVERS = [
  { name:'Lando Norris', number:1, team:'McLaren', unlock:100, code:'NOR', accent:'#ff8700' },
  { name:'Oscar Piastri', number:81, team:'McLaren', unlock:250, code:'PIA', accent:'#ff8700' },
  { name:'Max Verstappen', number:3, team:'Red Bull', unlock:500, code:'VER', accent:'#3671c6' },
  { name:'Charles Leclerc', number:16, team:'Ferrari', unlock:1000, code:'LEC', accent:'#e10600' },
  { name:'Lewis Hamilton', number:44, team:'Ferrari', unlock:1500, code:'HAM', accent:'#e10600' },
  { name:'George Russell', number:63, team:'Mercedes', unlock:2000, code:'RUS', accent:'#00a19c' },
  { name:'Kimi Antonelli', number:12, team:'Mercedes', unlock:3000, code:'ANT', accent:'#00a19c' },
  { name:'Fernando Alonso', number:14, team:'Aston Martin', unlock:4000, code:'ALO', accent:'#229971' },
  { name:'Carlos Sainz', number:55, team:'Williams', unlock:5000, code:'SAI', accent:'#64c4ff' },
  { name:'Alex Albon', number:23, team:'Williams', unlock:6500, code:'ALB', accent:'#64c4ff' },
  { name:'Pierre Gasly', number:10, team:'Alpine', unlock:8000, code:'GAS', accent:'#2293d1' },
  { name:'Franco Colapinto', number:43, team:'Alpine', unlock:10000, code:'COL', accent:'#2293d1' },
  { name:'Oliver Bearman', number:87, team:'Haas', unlock:12500, code:'BEA', accent:'#b6babd' },
  { name:'Esteban Ocon', number:31, team:'Haas', unlock:15000, code:'OCO', accent:'#b6babd' },
  { name:'Nico Hulkenberg', number:27, team:'Audi', unlock:17500, code:'HUL', accent:'#c92d4b' },
  { name:'Gabriel Bortoleto', number:5, team:'Audi', unlock:20000, code:'BOR', accent:'#c92d4b' },
  { name:'Sergio Perez', number:11, team:'Cadillac', unlock:25000, code:'PER', accent:'#d0d0d0' },
  { name:'Valtteri Bottas', number:77, team:'Cadillac', unlock:30000, code:'BOT', accent:'#d0d0d0' },
  { name:'Liam Lawson', number:30, team:'Racing Bulls', unlock:40000, code:'LAW', accent:'#6692ff' },
  { name:'Arvid Lindblad', number:41, team:'Racing Bulls', unlock:50000, code:'LIN', accent:'#6692ff' },
  { name:'Isack Hadjar', number:6, team:'Red Bull', unlock:65000, code:'HAD', accent:'#3671c6' },
  { name:'Fernando Alonso — Legend', number:14, team:'Aston Martin', unlock:80000, code:'LEG', accent:'#229971' }
];
