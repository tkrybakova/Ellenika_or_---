const F1_DRIVERS = [
  { name:'Lando Norris', number:1, team:'McLaren', unlock:1000, code:'NOR', accent:'#ff8700' },
  { name:'Oscar Piastri', number:81, team:'McLaren', unlock:8100, code:'PIA', accent:'#ff8700' },
  { name:'Max Verstappen', number:3, team:'Red Bull', unlock:5000, code:'VER', accent:'#3671c6' },
  { name:'Charles Leclerc', number:16, team:'Ferrari', unlock:1600, code:'LEC', accent:'#e10600' },
  ...
  { name:'Pierre Gasly', number:10, team:'Alpine', unlock:10000, code:'GAS', accent:'#2293d1' },
  ...
  { name:'Sergio Perez', number:11, team:'Cadillac', unlock:11000, code:'PER', accent:'#d0d0d0' },
